        ...
        <div class="timeline-item">
            ...
            <div class="timeline-content mb-10 mt-n2">
                ...
                <div class="overflow-auto pe-3">
                    <!--begin::Title-->
                    <div class="fs-5 fw-semibold mb-2"><strong>{{ $v->user->name ?? '-' }}</strong> {{ $v->desc }}
                    </div>
                    <!--end::Title-->
                    <!--begin::Description-->
            ...
            <div class="text-center py-10">
                <div class="card-px">
                    ...
                    <div class="text-center">
                        <h5 class="fw-bolder fs-3 text-dark">Tidak ada aktivitas</h5>
                        <div class="text-gray-400 fw-semibold fs-6">
                            Tidak ada log aktivitas pada tanggal
                            @if (isset($date))
                                {{ Helper::getHari(Carbon\Carbon::parse($date)->format('D')) . ', ' . Helper::getDateIndo(Carbon\Carbon::parse($date)) }}
                            @else
                                yang dipilih
                            @endif
                        </div>
